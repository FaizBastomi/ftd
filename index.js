...
const start = async function () {
    ...
    rl.question('\033[1;36mSearch: \033[1;32m', (input) => {
        ...
        rl.question('\033[1;36mHow many (default 5)\ninput: \033[1;32m', async (total) => {
...
const searchImage = async function (query, total) {
    ...
    for (let s = 0; s < jum; s++) {
        const res = await fetch(`https://meme-api.herokuapp.com/gimme/${encodeURIComponent(query)}`).catch(
            console.error,
        );
